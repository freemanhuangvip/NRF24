...
public class wonderfulGallery extends Gallery {
	/**
	...
	public wonderfulGallery(Context context) {
		this(context, null);
	}

	public wonderfulGallery(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public wonderfulGallery(Context context, AttributeSet attrs, int defStyle) {
	...
	protected boolean getChildStaticTransformation(View child, Transformation trans) {
		...
		if (childCenter == mCoveflowCenter) {
			transformImageBitmap(child, trans, 0);
		}else {
			...
			transformImageBitmap(child, trans, rotationAngle);
		}
		return true;
	}
